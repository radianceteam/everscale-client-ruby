...
TonSdk::Boc.parse_message(@c_ctx.context, TonSdk::Boc::ParamsOfParse.new(a1)) do |res|
  if res.success?
...
TonSdk::Boc.parse_transaction(@c_ctx.context, TonSdk::Boc::ParamsOfParse.new(a2)) do |res|
  if res.success?
...
TonSdk::Boc.parse_block(@c_ctx.context, TonSdk::Boc::ParamsOfParse.new(a3)) do |res|
  if res.success?
...
TonSdk::Boc.get_blockchain_config(@c_ctx.context, TonSdk::Boc::ParamsOfGetBlockchainConfig.new(a4)) do |res|
  if res.success?
