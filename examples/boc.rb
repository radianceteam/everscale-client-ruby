...
EverSdk::Boc.parse_message(@c_ctx.context, EverSdk::Boc::ParamsOfParse.new(boc: a1)) do |res|
  if res.success?
...
EverSdk::Boc.parse_transaction(@c_ctx.context, EverSdk::Boc::ParamsOfParse.new(boc: a2)) do |res|
  if res.success?
...
EverSdk::Boc.parse_block(@c_ctx.context, EverSdk::Boc::ParamsOfParse.new(boc: a3)) do |res|
  if res.success?
...
EverSdk::Boc.get_blockchain_config(@c_ctx.context, EverSdk::Boc::ParamsOfGetBlockchainConfig.new(block_boc: a4)) do |res|
  if res.success?
