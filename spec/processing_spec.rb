...
describe EverSdk::Processing do
  context "methods of processing" do
    xit "send and wait for message" do
      ...
      pr_s1 = EverSdk::Abi::ParamsOfEncodeMessage.new(
        abi: abi,
        deploy_set: EverSdk::Abi::DeploySet.new(tvc: tvc),
      ...
      EverSdk::Abi.encode_message(@c_ctx.context, pr_s1) { |a| @res1 = a }
      ...
      pr_s2 = EverSdk::Processing::ParamsOfSendMessage.new(
        abi: abi,
      ...
      EverSdk::Processing::send_message(@c_ctx.context, pr_s2, resp_handler) { |a| @res2 = a }
      ...
      pr_s3 = EverSdk::Processing::ParamsOfWaitForTransaction.new(
        abi: abi,
        message: @res1.result.message,
      ...
      EverSdk::Processing::wait_for_transaction(@c_ctx.context, pr_s3, resp_handler) { |a| @res3 = a }
      ...
      for x in 0..@events.size
        evt_tp = EverSdk::Helper.capitalized_case_str_to_snake_case_sym(@events.pop["type"])
        is_type_known = EverSdk::Processing::ProcessingEvent::TYPES.include?(evt_tp)
